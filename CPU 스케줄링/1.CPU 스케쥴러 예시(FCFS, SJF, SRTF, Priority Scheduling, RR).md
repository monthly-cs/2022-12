...
### 2.1. [Non-preemptive] FCFS, First Come First Serve
...
### 2.2. [Non-preemptive] SJF, Shortest Job First
...
### 2.3. [Non-preemptive] LJF, Longes Job First
...
### 2.4. [Preemptive] PS, Priority Scheduling
...
### 2.6. [Preemptive] SRTF, Shortest Remaining Time First
...
5. (BAD) SRFT는 SJF와 동일하게 우선순위에 의존하고 있으므로 **기아 상태**의 위험성이 존재합니다.
...
### 2.7. [Preemptive] LRTF, Longest Remaining Time First
...
6. (BAD) 이 알고리즘은 LJF와 동일하게 **호송 상태**의 위험성이 있습니다.
...
### 2.8. [Preemptive] HRRN, Highest Response Ratio Next
...
1. HRRN은 SJF을 기반으로 **기아 문제**를 해결하기 위해 응답 비율을 도입한 것으로 간주됩니다.
